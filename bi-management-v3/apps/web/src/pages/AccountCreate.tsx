...
export default function AccountCreate() {
  ...
  useEffect(() => {
    document.title = "إضافة حساب | BI Management v3";
  ...
  return (
    <div>
      <PageHeader
        ...
        extra={
          <Button icon={<ArrowRightOutlined />} onClick={() => navigate("/accounts")}>
            العودة للحسابات
          </Button>
        }
      />
      ...
      <Form
        ...
        initialValues={{ type: "asset", nature: "debit" }}
        style={{ maxWidth: 800 }}
      >
        <Card title="معلومات الحساب" style={{ marginBottom: 24 }}>
          <Row gutter={16}>
            <Col xs={24} md={8}>
              ...
              >
                <Input placeholder="مثال: 1101" style={{ fontFamily: "monospace" }} />
              </Form.Item>
            </Col>
            <Col xs={24} md={8}>
              <Form.Item
        ...
        <Space>
          <Button onClick={() => navigate("/accounts")}>إلغاء</Button>
