    ...
    <>
      <div className={clsx(
        ...
        task.completed 
          ...
          : 'bg-white dark:bg-surface-800 border-surface-200 dark:border-surface-700 hover:border-primary-300'
      )}>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 border border-surface-300 dark:border-surface-600 rounded-lg 
