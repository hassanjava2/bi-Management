...
async function list(filters = {}) {
    ...
    let query = `SELECT v.*, u.full_name as created_by_name FROM vouchers v LEFT JOIN users u ON v.created_by = u.id WHERE (v.is_deleted IS NOT TRUE OR v.is_deleted IS NULL)`;
    const params = [];
